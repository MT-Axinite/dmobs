...
--mobs:register_spawn("dmobs:dragon", {"default:leaves","default:dirt_with_grass"}, 20, 10, 64000, 2, 31000,false)

--mobs:register_spawn("dmobs:dragon2", {"default:pine_needles"}, 20, 10, 64000, 2, 31000, false)
mobs:register_spawn("dmobs:dragon3", {"axinitium:axinite_dirt"}, 20, 10, 32000, 2, 31000)
--mobs:register_spawn("dmobs:dragon4", {"default:jungleleaves"}, 20, 10, 64000, 2, 31000, false)
...
mobs:register_spawn("dmobs:dragon_great", {"nether:rack"}, 20, 10, 64000, -2, -10000)
